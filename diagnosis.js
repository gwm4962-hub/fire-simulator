    ...
    try {
      const res = await fetch('https://fire-simulator-mv3a.onrender.com/api/diagnosis', {
        ...
        body: JSON.stringify({
          ...
          bankrupt_rate:      result.bankruptRate      ?? null,
          ...
          // 65歳時シナリオ幅
          p10_at65_man:       result.p10At65Man        ?? null,
          p90_at65_man:       result.p90At65Man        ?? null,
          // 入力パラメータ
          ...
          init_assets_man:    result.initAssetsMan     ?? null,
          fire_thr_man:       result.fireThrMan        ?? null,
          annual_income_man:  result.annualIncomeMan   ?? null,
          is_dual:            result.isDual            ?? null,
          raise_rate_pct:     result.raiseRatePct      ?? null,
          monthly_pension_man: result.monthlyPensionMan ?? null,
          inheritance_man:    result.inheritanceMan    ?? null,
          retire_years:       result.retireYears       ?? null,
          med_death_age:      result.medDeathAge       ?? null,
          fire_gap_man:       result.fireGapMan        ?? null,
          years_to_fire:      result.yearsToFire       ?? null,
        }),
      });
