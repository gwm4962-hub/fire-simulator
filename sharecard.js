...
@media (max-width: 480px) {
  ...
  function _tryHarvestResult() {
    ...
    const mRetEl = document.getElementById('kpi-monthly-retire') || document.getElementById('bsumm-monthly');
    const monthlyRetire = parseFloat((mRetEl?.textContent||'').replace(/[^0-9.]/g,'')) || 0;
